...
#         self.conv1 = nn.Conv2d(1,1,(1,1),1,0,1,1,bias=False)
#         self.conv2_1 = nn.Conv2d(1,1,(3,3),1,1,1,1,bias=False,padding_mode='circular')
#         self.conv2_3 = nn.Conv2d(1,1,(3,3),1,3,3,1,bias=False,padding_mode='circular')
#         self.conv2_5 = nn.Conv2d(1,1,(3,3),1,5,5,1,bias=False,padding_mode='circular')
#         self.conv2d = nn.Conv2d(4,1,(3,3),1,1,bias=False)
#         self.linear = nn.Linear(enc_in,enc_in)
#         self.linear2 = nn.Linear(enc_in,enc_out)
...
#         x3 = self.conv2_3(x)
#         x5 = self.conv2_5(x)
#         x_total2 = torch.concatenate((x1,x2,x3,x5),dim=1)
#         x_total2 = x_total2.to(torch.float32)
#         xout1 = self.conv2d(x_total2)
#         xout1 = xout1.squeeze()
#         x_total1= torch.sum(x_total2,dim=1)
#         x_total1 = x_total1.permute(0,2,1)
#         xout2 = self.linear(x_total1)
#         xout1 =xout1.permute(0,2,1)
#         xout = torch.add(xout1,xout2)
#         xout = self.linear2(xout)
#         xout_total = self.sigmod(xout.permute(0,2,1))
#         return xout_total
